...
INSERT INTO recette (nom_recette, date_creation_recette, temps_preparation, temps_cuisson, nombre_personnes, texte_preparation)
VALUES ('Flan', NOW(), TIME '00:30:00', TIME '00:20:00', 4, 'Préparation du flan');

UPDATE recette
SET temps_cuisson = TIME '00:25:00'
...
VALUES (
  (SELECT internaute.id_internaute
   FROM internaute
   WHERE internaute.pseudonyme = 'Bibiche'),
  'Anniversaire hivernal');

UPDATE menu
SET nom_menu = 'Anniversaire estival'
